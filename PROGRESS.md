...
## Current status
- **Phase:** 4 COMPLETE — verified + design-reviewed + fixes landed. **CHECK-IN POSTED, awaiting user approval. Next = Phase 5 (Interview Platform), ONE type per window: Coding (Monaco) first; reuse interview-prep CLAUDE.md protocol (Frame→Interrogate→Scorecard) as the spec; scorecards write back to Memory.**
